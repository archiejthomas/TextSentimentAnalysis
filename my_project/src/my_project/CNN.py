...
def CNNprepData(df):
    ...
    ----------
    df : Dataframe 
        Our Financial Phrasebank dataframe


    Returns
    -------
    X : Dataframe
        Contains the sentences of the financial phrasebank replaced with their
        embeddings, padded to maxlen
        
    y: Dataframe
        Contains the encoded labels
